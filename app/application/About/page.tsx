  ...
  return (
    <>
      <div className="text-center">
        APN Elec are certified by NAPIT to provide both Electrical and Solar PV
        installation. We also come with Part P certification for Building
        Regulations. APN Elec is qualified to the latest 18th Edition
        Regulations for Electrical work and EV Charging. APN Elec is proud to be
        a member of Trustmark. Trustmark is a consumer protection body which was
        established in 2005 by a joint commission of the Government and industry
        bodies. Its goal is to regulate all industries in and around the home,
        and to ensure their Registered Businesses maintain required standards of
        technical competence, customer service and trading practices. <p></p>
      </div>
      <div
